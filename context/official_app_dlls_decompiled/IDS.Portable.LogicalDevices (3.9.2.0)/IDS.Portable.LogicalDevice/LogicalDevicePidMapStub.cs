...
{
	public class LogicalDevicePidMapStub<TValue> : LogicalDevicePidStub, ILogicalDevicePidMap<TValue>, ILogicalDevicePidProperty<TValue>, ILogicalDevicePid<TValue>, ILogicalDevicePid, ILogicalDevicePidProperty, ICommonDisposable, IDisposable, INotifyPropertyChanged
	{
		...
		public LogicalDevicePidMapStub(ulong value, Func<ulong, TValue> mapToValue, ILogicalDevice logicalDevice, PID pid)
			: base(logicalDevice, pid, value)
		{
			MapToValue = mapToValue;
		}

		public new Task<TValue> ReadAsync(CancellationToken cancellationToken)
		{
