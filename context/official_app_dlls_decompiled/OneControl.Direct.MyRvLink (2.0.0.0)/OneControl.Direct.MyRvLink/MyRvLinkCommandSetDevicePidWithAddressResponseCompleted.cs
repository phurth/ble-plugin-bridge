...
{
	public class MyRvLinkCommandSetDevicePidWithAddressResponseCompleted : MyRvLinkCommandResponseSuccess
	{
		public const string LogTag = "MyRvLinkCommandSetDevicePidWithAddressResponseCompleted";
		...
		public MyRvLinkCommandSetDevicePidWithAddressResponseCompleted(ushort clientCommandId, ushort pidAddress, uint pidValue)
			: base(clientCommandId, commandCompleted: true, EncodeExtendedData(pidAddress, pidValue))
		{
		}

		public MyRvLinkCommandSetDevicePidWithAddressResponseCompleted(IReadOnlyList<byte> rawData)
			: base(rawData)
		{
		}

		public MyRvLinkCommandSetDevicePidWithAddressResponseCompleted(MyRvLinkCommandResponseSuccess response)
		...
		public override string ToString()
		{
			...
			defaultInterpolatedStringHandler.AppendFormatted("MyRvLinkCommandSetDevicePidWithAddressResponseCompleted");
