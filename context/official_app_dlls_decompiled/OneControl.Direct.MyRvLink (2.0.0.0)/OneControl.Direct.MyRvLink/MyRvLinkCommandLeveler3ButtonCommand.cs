...
namespace OneControl.Direct.MyRvLink
{
	public class MyRvLinkCommandLeveler3ButtonCommand : MyRvLinkCommand
	{
		...
		protected virtual string LogTag { get; } = "MyRvLinkCommandLeveler3ButtonCommand";


		public override MyRvLinkCommandType CommandType { get; } = MyRvLinkCommandType.Leveler3ButtonCommand;
		...
		protected MyRvLinkCommandLeveler3ButtonCommand(IReadOnlyList<byte> rawData)
		{
		...
		public static MyRvLinkCommandLeveler3ButtonCommand Decode(IReadOnlyList<byte> rawData)
		{
		...
		{
			DefaultInterpolatedStringHandler defaultInterpolatedStringHandler = new DefaultInterpolatedStringHandler(101, 8);
			...
			defaultInterpolatedStringHandler.AppendFormatted(ScreenEnum, "X2");
