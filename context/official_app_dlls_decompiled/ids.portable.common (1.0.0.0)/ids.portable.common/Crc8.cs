...
namespace IDS.Portable.Common
{
	public struct Crc8
	{
		...
		public byte Value
		{
			get
			{
				return _value.GetValueOrDefault(85);
			}
			private set
			{
				_value = value;
		...
		[MethodImpl(MethodImplOptions.AggressiveInlining)]
		public static byte Calculate(IReadOnlyList<byte> buffer)
		{
			return Calculate(85, buffer, buffer.Count, 0);
		}

		[MethodImpl(MethodImplOptions.AggressiveInlining)]
		public static byte Calculate(IReadOnlyList<byte> buffer, int count)
		{
			return Calculate(85, buffer, count, 0);
		}

		[MethodImpl(MethodImplOptions.AggressiveInlining)]
		public static byte Calculate(IReadOnlyList<byte> buffer, int count, int offset)
		{
			return Calculate(85, buffer, count, offset);
		}

		private static byte Calculate(byte crc, IReadOnlyList<byte> buffer, int count, int offset)
		{
		...
		public static byte Calculate(IReadOnlyCollection<byte> bytes)
		{
			byte b = 85;
			if (bytes != null)
			{
